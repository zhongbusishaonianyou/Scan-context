...
{  
    ...
    //PC_NUM_RING=20，PC_NUM_SECTOR=60
    MatrixXd desc = NO_POINT * MatrixXd::Ones(PC_NUM_RING, PC_NUM_SECTOR);
    ///////////////////////////////////////////////////////////////////////
    MatrixXd distance=  MatrixXd::Zero(PC_NUM_RING, PC_NUM_SECTOR);
    MatrixXd bin_point_size=  MatrixXd::Ones(PC_NUM_RING, PC_NUM_SECTOR);
    //MatrixXi desc = MatrixXi::Ones(PC_NUM_RING, PC_NUM_SECTOR);
...
{   
    ...
    //eigen<double,x,x> 转为 vector<float>
...
{   
    ...
    {  
        ...
        //将polarcontext_invkeys_mat_.begin(), polarcontext_invkeys_mat_.end() - NUM_EXCLUDE_RECENT 赋值到polarcontext_invkeys_to_search
        polarcontext_invkeys_to_search_.assign( polarcontext_invkeys_mat_.begin(), polarcontext_invkeys_mat_.end() - NUM_EXCLUDE_RECENT ) ;
        // std::unique_ptr< KDTreeVectorOfVectorsAdaptor< KeyMat, float > >
